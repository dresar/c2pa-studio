...
class _$ProjectModelImpl implements _ProjectModel {
  ...
  @override
  String toString() {
    return 'ProjectModel(id: $id, userId: $userId, name: $name, description: $description, thumbnailUrl: $thumbnailUrl, status: $status, totalImages: $totalImages, totalSizeBytes: $totalSizeBytes, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, userId, name, description,
      thumbnailUrl, status, totalImages, totalSizeBytes, createdAt, updatedAt);
